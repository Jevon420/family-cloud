...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Upload New Photo</h1>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden p-6">
        <form action="{{ route('admin.photos.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" name="photo" id="photo" class="mt-1 block w-full" accept="image/*" required>
                <p class="mt-1 text-sm text-gray-500">Required. Maximum file size: 10MB.</p>
                @error('photo')
            ...
            <div class="mb-4">
                ...
                <select name="gallery_id" id="gallery_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                    ...
                    <option value="{{ $gallery->id }}" {{ old('gallery_id', request()->query('gallery_id')) == $gallery->id ? 'selected' : '' }}>
