...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><strong>{{ $sharedBy->name }}</strong> has shared a {{ $mediaType }} link with you: <strong>{{ $mediaName }}</strong></p>
            ...
            <div class="info">
                ...
                @if($expiresAt)
                <p class="expire-info">This link will expire on {{ $expiresAt->format('F j, Y \a\t g:i A') }}</p>
                @endif
            </div>
            ...
            <p>No account is required to access this content through the link.</p>
        </div>
